...
import 'package:resecure_user/recording.dart'; // Import your Recording model
...
class FirebaseDataService {
  ...
  Future<List<Recording>> fetchRecordings(
    ...
    final ref = _database.ref().child('recordings').orderByChild('camera_id').equalTo(cameraId);
    ...
    for (var child in snapshot.children) {
      ...
      if (data != null) {
        ...
        if (recording.datetime.isAfter(startDate) && recording.datetime.isBefore(endDate)) {
